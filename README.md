...
*⇒ 사용자들이 납득할 수 있을 만한 추천 알고리즘이 설계되어야 한다.*
...
- *정부, 지방자치단체의 정보를 활용하는 것이 가장 적합하다.*
- 그런 곳은 빅데이터라고 할 만한 큰 규모의 데이터들이 많다
- *칸프 - 중소기업에서 관리하고 있는 오픈 데이터, iot 정보라던지 이용할 수있다.*
...
- 하지만 전체 흐름에 따라서 오르내리는 것이 있다. *업계 전체가 휩쓸리는 것은 어느정도 예측하는 것이 가능하다.*
